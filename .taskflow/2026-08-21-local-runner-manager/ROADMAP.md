...
complete (`c1`); `v1` and `a1` merged. `a1` and `b1` merged. In flight: `d1`,
`c2`, and a B-group correction round on `b1`.
...
| [c2-device-flow-auth](tasks/c2-device-flow-auth.md) | c1, b1 | 10/7 | top | 🔵 in progress | round 4 (local) | 2026-08-21 |
| [c3-rest-inventory-gateway](tasks/c3-rest-inventory-gateway.md) | c2 | 8/6 | mid | ⬜ pending | | |
| [d1-platform-core](tasks/d1-platform-core.md) | a1 | 9/6 | top | 🔵 in progress | round 3 (local) | 2026-08-21 |
...
| [a2-release-workflow](tasks/a2-release-workflow.md) | a1 | 8/6 | top | 🔒 gate 5 | — | 2026-08-21 |
